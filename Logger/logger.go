...
var precertstorage Precertstorage
...
func HandlePrecert(w http.ResponseWriter, r *http.Request){
...
func RunLogger(configFile string) {
	...
	getLoggerType()
	precertstorage = Storage_init(2)
	fill_with_data()
	handleLoggerRequests()
